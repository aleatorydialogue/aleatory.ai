...
async function main() {
    ...
    // List of available models
    	const modelNames = ["dino.splat", "canterbury.splat", "bliss.splat", "stream2.splat", "market.splat", "marsh.splat", "driftwood.splat", "posts.splat", "shed.splat", "money.splat", "lighthouse.splat", "stairs.splat", "deck.splat", "tree1.splat", "tree2.splat", "riteaid.splat", "francis.splat", "cabin.splat", "garage.splat", "reindeer.splat", "winery.splat", "astronaut.splat", "pen.splat", "main_fossil.splat", "easter.splat", "snowman.splat", "underwater_world.splat", "galaxy.splat", "stones.splat", "NH_24.splat", "ammonoosuc.splat", "sculpt.splat", "island.splat", "atrium1.splat", "fish.splat", "waterslide.splat", "aloft.splat", "turtle.splat", "atrium2.splat", "jaws.splat", "butterfly.splat", "bridge.splat"];
